            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                    <a href="#" target="_blank" title="专业网站建设">
                        <img src="<?=Url::to('/static/images/201610241227558789.jpg')?>" alt="专业网站建设" class="img-responsive"></a>
                </div>
            </div>
...
<aside class="sidebar">
    ...
    <div class="widget widget_hot">
        ...
        <ul>
            <li><a title="用DTcms做一个独立博客网站（响应式模板）" href="#"><span class="thumbnail">
				<img class="thumb" src="<?=Url::to('/static/images/201610181739277776.jpg') ?>"
    ...
    <div class="widget widget_sentence">
        <a href="#" target="_blank" rel="nofollow" title="专业网站建设">
            <img style="width: 100%" src="<?=Url::to('/static/images/201610241224221511.jpg')?>" alt="专业网站建设"></a>
    </div>
    <div class="widget widget_sentence">
        <a href="#" target="_blank" rel="nofollow" title="MZ-NetBlog主题">
            <img style="width: 100%" src="<?=Url::to('/static/images/ad.jpg')?>" alt="MZ-NetBlog主题"></a>
    </div>
    <div class="widget widget_sentence">
        <h3>友情链接</h3>
